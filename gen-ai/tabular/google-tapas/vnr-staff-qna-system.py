...
table = pd.read_csv('vnr-data.csv')
...
queries = [
    "Who is the Physical Director at the institution?",
    "Which department does Parvathaneni Raghavaiah belong to?",
    "What is the highest qualification of Garikapati Ramakrishna Rao?",
    "Which department has the highest number of staff members listed in the provided data?",
    "Are there any staff members with an MBA qualification in the given data?"
